...
$.fn.numeric = function(config, callback)
{
	...
	return this.data("numeric.decimal", decimal).data("numeric.altDecimal", altDecimal).data("numeric.negative", negative).data("numeric.callback", callback).data("numeric.decimalPlaces", decimalPlaces).keypress($.fn.numeric.keypress).keyup($.fn.numeric.keyup).on("input", $.fn.numeric.keyup).blur($.fn.numeric.blur);
};
...
$.fn.numeric.blur = function()
{
	...
	if(val !== "")
	{
		...
		if (val.slice(-1) == '.') //remove extra dot
			val = val.slice(0, -1);
